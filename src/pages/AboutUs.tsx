            ...
            <div className="container mx-auto pt-6 px-4">
                ...
                <div className="md:py-20 py-12 gap-12 grid xl:grid-cols-2 grid-cols-1 items-center">
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="h-full gap-6 mt-2 grid md:grid-cols-2 grid-cols-1 items-center justify-center">
                            ...
                            <div className="h-full bg-color_02 p-4 rounded-lg flex flex-col gap-2">
